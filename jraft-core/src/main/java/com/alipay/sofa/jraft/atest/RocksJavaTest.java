package com.alipay.sofa.jraft.atest;
...
public class RocksJavaTest {
    ...
    private static final String dbPath = "C:\\d\\rocks";
...
//        test.testDefaultColumnFamily();
    ...
    public void testDefaultColumnFamily() throws RocksDBException, IOException {
        ...
        List<byte[]> valueMap = rocksDB.multiGetAsList(keys);
        for (byte[] entry : valueMap) {
